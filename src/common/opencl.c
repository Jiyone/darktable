...
gboolean dt_opencl_read_device_config(const int devid)
{
  ...
  int avoid_atomics = dt_opencl_get_conf_int(key_device, "avoid_atomics", &safety_ok);
  int micro_nap = dt_opencl_get_conf_int(key_device, "micro_nap", &safety_ok);
  int pinned_memory = dt_opencl_get_conf_int(key_device, "pinned_memory", &safety_ok);
  int wd = dt_opencl_get_conf_int(key_device, "wd", &safety_ok);
  int ht = dt_opencl_get_conf_int(key_device, "ht", &safety_ok);
  int event_handles = dt_opencl_get_conf_int(key_device, "event_handles", &safety_ok);
  int disabled = dt_opencl_get_conf_int(key_device, "disabled", &safety_ok);
  float benchmark = dt_opencl_get_conf_float(key_device, "benchmark", &safety_ok);
